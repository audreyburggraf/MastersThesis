...
def get_beam_info(header):
    ...
    pixel_size_x_deg =  abs(header.get('CDELT1'))  # degrees per pixel (X-axis)
    ...
    BPA_deg  = header.get('BPA')   # beam position angle in degrees
    
    BPA_deg_cartesian = astronomy_to_cartesian(BPA_deg)
    ...
    return BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg, BPA_deg_cartesian

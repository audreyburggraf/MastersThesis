...
# ---------------------------------------------
writeup_grid_lw = 2.2
writeup_grid_axis_label_fs = 25# 22.5
writeup_grid_axis_num_fs = 22 # 22.5
# ---------------------------------------------
...
writeup_tables_folder_path = writeup_path + "IMAGES/WRITEUP/TABLES/"
...
rms_data = {
    ...
    "band5_nterms2": {
        ...
        "Q": [0.0137, 0.0133, 0.0135, 0.0128], #[0.0394, 0.0406, 0.0398, 0.0422],
        "U": [0.0150, 0.0152, 0.0144, 0.0157], #[0.0408, 0.0394, 0.0410, 0.0420]
    },

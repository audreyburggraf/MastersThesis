...
major_angle_deg_plot = major_angle_deg - 90
minor_angle_deg_plot = minor_angle_deg - 90

# We can turn the plotted angles into radians
minor_angle_rad_plot = np.radians(minor_angle_deg_plot)
major_angle_rad_plot = np.radians(major_angle_deg_plot)
=======
...
for x in range(0, nx, step):
    for y in range(0, ny, step):
        ...
        if (StokesI_data_2d_mJy[y, x] / StokesIerr_data_2d_mJy[y, x] > 3 and 
            ...
            # Compute the vector components
            dx = vector_length_pix_const * np.cos(minor_angle_rad_plot)
            dy = vector_length_pix_const * np.sin(minor_angle_rad_plot)
...
<<<<<<< HEAD
        PA_grid_100Uniform[y, x] = minor_angle_rad_plot
...
<<<<<<< HEAD
        ...
        PA_grid_100Azimuthal[y, x] = azimuthal_angle_rad 
# --------------------------------------------------------------------------------------------------              
=======

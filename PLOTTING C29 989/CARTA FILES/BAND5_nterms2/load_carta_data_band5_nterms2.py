...
carta_image_path_band5_nterms2 = "/Users/audreyburggraf/Desktop/QUEEN'S/THESIS RESEARCH/PLOTTING C29 989/CARTA FILES/BAND5_nterms2/"




# ------------------------------------------------------------------------------------------------------
carta_major_df_StokesI = pd.read_csv(carta_image_path_band5_nterms2 + "IRS63_StokesI_CARTA_MAJOR_AXIS_BAND5_18.csv", 
...
# ------------------------------------------------------------------------------------------------------
carta_minor_df_StokesI = pd.read_csv(carta_image_path_band5_nterms2 + "IRS63_StokesI_CARTA_MINOR_AXIS_BAND5_18.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  
...
# ------------------------------------------------------------------------------------------------------
carta_major_df_POLI = pd.read_csv(carta_image_path_band5_nterms2 + "IRS63_POLI_CARTA_MAJOR_AXIS_BAND5_18.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  
...
# ------------------------------------------------------------------------------------------------------
carta_minor_df_POLI = pd.read_csv(carta_image_path_band5_nterms2 + "IRS63_POLI_CARTA_MINOR_AXIS_BAND5_18.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  

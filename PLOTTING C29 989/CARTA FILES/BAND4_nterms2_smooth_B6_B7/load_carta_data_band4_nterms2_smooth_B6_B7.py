...
loc = "/Users/audreyburggraf/Desktop/QUEEN'S/THESIS RESEARCH/PLOTTING C29 989/CARTA FILES/BAND4_nterms2_smooth_B6_B7/"




# ------------------------------------------------------------------------------------------------------
carta_major_df_StokesI = pd.read_csv(loc + "IRS63_StokesI_CARTA_MAJOR_AXIS_BAND4_nterms2_smooth_B6_B7.csv", 
...
# ------------------------------------------------------------------------------------------------------
carta_minor_df_StokesI = pd.read_csv(loc + "IRS63_StokesI_CARTA_MINOR_AXIS_BAND4_nterms2_smooth_B6_B7.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  
...
# ------------------------------------------------------------------------------------------------------
carta_major_df_POLI = pd.read_csv(loc + "IRS63_POLI_debiased_CARTA_MAJOR_AXIS_BAND4_nterms2_smooth_B6_B7.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  
...
# ------------------------------------------------------------------------------------------------------
carta_minor_df_POLI = pd.read_csv(loc + "IRS63_POLI_debiased_CARTA_MINOR_AXIS_BAND4_nterms2_smooth_B6_B7.csv", 
                       delim_whitespace=True,  # Auto-detects spaces/tabs as delimiter
                       header=None, 
                       skiprows = 6,
                       names=["Offset (arcsec)", "Value (Jy/beam)"])  

...
# Save data
# ----------------------------------------------------------------------------------------------------
# Save the normal data if needed
# -----------------------------------------------------------------------------------------------------
exportfits(imagename='irs63_c561_p4.image.tt0',fitsimage='IRS63_BAND5_StokesI_redo_nterms1.fits')
exportfits(imagename='irs63_c561_p4_stokesQ.image.tt0',fitsimage='IRS63_BAND5_StokesQ_redo_nterms1.fits')
exportfits(imagename='irs63_c561_p4_stokesU.image.tt0',fitsimage='IRS63_BAND5_StokesU_redo_nterms1.fits')





# ROUND 5 OF SELF CALIBRATION with robust = -2
# ---------------------------------------------------------------------
# ---------------------------------------------------------------------
for ext in ['.flux','.image','.mask','.model','.pbcor','.psf','.residual','.flux.pbcoverage','.pb','.wtsum']:
      rmtables(contimagename + '_p4'+ ext)
...
tclean(vis = contvis,
         imagename = contimagename+'_p4_robust_minus2',
         stokes = 'I',
         outframe = 'LSRK',
         specmode = 'mfs',
         nterms = 1,
...
# CLEAN STOKES Q with robust = -2
# ---------------------------------------------------------------------
# ---------------------------------------------------------------------
tclean(vis = contvis,
         imagename = contimagename+'_p4_robust_minus2_stokesQ',
         stokes = 'Q',
         outframe = 'LSRK',
         specmode = 'mfs',
         nterms = 1,
...
# CLEAN STOKES U with robust = -2
# ---------------------------------------------------------------------
# ---------------------------------------------------------------------
tclean(vis = contvis,
         imagename = contimagename+'_p4_robust_minus2_stokesU',
         stokes = 'U',
         outframe = 'LSRK',
         specmode = 'mfs',
         nterms = 1,
...
# -----------------------------------------------------------------------------------------------------
# Save the robust = -2 data 
# -----------------------------------------------------------------------------------------------------
exportfits(imagename='irs63_c561_p4_robust_minus2.image.tt0',fitsimage='IRS63_BAND5_StokesI_redo_nterms1_robust_minus2.fits')
exportfits(imagename='irs63_c561_p4_robust_minus2_stokesQ.image.tt0',fitsimage='IRS63_BAND5_StokesQ_redo_nterms1_robust_minus2.fits')
exportfits(imagename='irs63_c561_p4_robust_minus2_stokesU.image.tt0',fitsimage='IRS63_BAND5_StokesU_redo_nterms1_robust_minus2.fits')
# -----------------------------------------------------------------------------------------------------

...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_nterms2)
# -------------------------------------------------------------------------------------------------------
...
hdu.writeto(band7_nterms2_data_folder_path + "POLI_mJy_calculated_BAND7_nterms2.fits", overwrite=True)
...
results = generate_polarization_vectors_band47(ny, nx,
                                               ...
                                               constants.minor_angle_rad_sky_band7_nterms2,
                                               StokesI_mJy, 

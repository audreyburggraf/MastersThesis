...
band7_uncalibrated_data_folder_path = constants.band7_uncalibrated_data_folder_path
...
# Define file paths
StokesI_file      = band7_uncalibrated_data_folder_path + "IRS63_StokesI_uncalibrated_BAND7.fits"
# StokesI_err_file  = band7_data_folder_path + "c2d_989_StokesIerr_233GHz.fits"
StokesQ_file      = band7_uncalibrated_data_folder_path + "IRS63_StokesQ_uncalibrated_BAND7.fits"
StokesU_file      = band7_uncalibrated_data_folder_path + "IRS63_StokesU_uncalibrated_BAND7.fits"
PA_file           = band7_uncalibrated_data_folder_path + "member.uid___A001_X133d_X15c9.IRS63_sci.spw13_15_17_19.mfs.A.manual.pbcor.fits"
...
POLI_file         = band7_uncalibrated_data_folder_path + "member.uid___A001_X133d_X15c9.IRS63_sci.spw13_15_17_19.mfs.P.manual.pbcor.fits"
# POLI_err_file     = band7_data_folder_path + "c2d_989_POLIerr_233GHz.fits"


# Stokes I
# -------------------------------------------------------------------------------------------------------
StokesI_header, _, StokesI_Jy, StokesI_wcs = read_in_file(StokesI_file, dimensions = 2)
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_uncalibrated)
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_uncalibrated)
...
POLI_err_mJy = np.full((ny, nx), constants.POLI_err_mJy_band7_uncalibrated)
...
results = generate_polarization_vectors_band47(ny, nx,
                                               ...
                                               PA_rad, PA_err_deg,
                                               'band 7', step = 3, vector_len_pix = 1.5)
# -------------------------------------------------------------------------------------------------------

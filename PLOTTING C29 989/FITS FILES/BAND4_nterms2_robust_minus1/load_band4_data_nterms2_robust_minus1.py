...
loc = constants.band4_nterms2_robust_minus1_data_folder_path
...
StokesI_file         = loc + "IRS63_BAND4_nterms2_robust_minus1_StokesI.fits"
StokesQ_file         = loc + "IRS63_BAND4_nterms2_robust_minus1_StokesQ.fits"
StokesU_file         = loc + "IRS63_BAND4_nterms2_robust_minus1_StokesU.fits"
POLI_biased_file     = loc + "POLI_biased_mJy_BAND4_nterms2_robust_minus1.fits"
POLI_err_file        = loc + "POLI_err_mJy_BAND4_nterms2_robust_minus1.fits"
POLI_dedebiased_file = loc + "POLI_debiased_mJy_BAND4_nterms2_robust_minus1.fits"
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band4_nterms2_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band4_nterms2_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band4_nterms2_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 4 nterms2 robust -1')
...
results = generate_polarization_vectors(ny, nx,
                                        ...
                                        constants.minor_angle_rad_sky_band4_nterms2_robust_minus1,
                                        StokesI_mJy,
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 4 nterms2 robust -1', print_statements=False)
# -----------------------------------------------------------------

...
band5_nterms2_data_folder_path = constants.band5_nterms2_data_folder_path
...
# Define file paths
StokesI_file = band5_nterms2_data_folder_path + "IRS63_BAND5_StokesI.fits"
StokesQ_file = band5_nterms2_data_folder_path + "IRS63_BAND5_StokesQ.fits"
StokesU_file = band5_nterms2_data_folder_path + "IRS63_BAND5_StokesU.fits"
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band5_nterms2)
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band5_nterms2)
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band5_nterms2)
# -------------------------------------------------------------------------------------------------------
...
hdu.writeto(band5_nterms2_data_folder_path + "POLI_mJy_calculated_BAND5_nterms2.fits", overwrite=True)
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 5 nterms2')
...
results_stream = generate_polarization_vectors(ny, nx,
                                               xmin, xmax, ymin, ymax, # This is for the nterms test
                                               RA_centre_pix, Dec_centre_pix,
                                               constants.minor_angle_rad_sky_band5_nterms2,
                                               StokesI_mJy, 
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 5 nterms2', print_statements=False)
# -----------------------------------------------------------------

...
band7_redo_data_folder_path = constants.band7_redo_data_folder_path
...
# Define file paths
StokesI_file      = band7_redo_data_folder_path + "IRS63_BAND7_StokesI_clean_nopbcorr.fits"
# StokesI_err_file  = band7_redo_redo_data_folder_path + "c2d_989_StokesIerr_233GHz.fits"
StokesQ_file      = band7_redo_data_folder_path + "IRS63_BAND7_StokesI_clean_nopbcorr.fits"
StokesU_file      = band7_redo_data_folder_path + "IRS63_BAND7_StokesI_clean_nopbcorr.fits"
# PA_file           = band7_redo_data_folder_path + "c2d_989_POLA_233GHz.fits"
# PA_err_file       = band7_redo_data_folder_path + "c2d_989_POLAerr_233GHz.fits"
# POLF_file         = band7_redo_data_folder_path + "c2d_989_POLF_233GHz.fits"
# POLF_err_file     = band7_redo_data_folder_path + "c2d_989_POLFerr_233GHz.fits"
# POLI_file         = band7_redo_data_folder_path + "c2d_989_POLI_233GHz.fits"
# POLI_err_file     = band7_redo_data_folder_path + "c2d_989_POLIerr_233GHz.fits"
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band7_redo)
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_redo)
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_redo)
# -------------------------------------------------------------------------------------------------------

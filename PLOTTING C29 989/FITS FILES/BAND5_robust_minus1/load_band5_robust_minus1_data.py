...
band5_robust_minus1_data_folder_path = constants.band5_robust_minus1_data_folder_path
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band5_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band5_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band5_robust_minus1)
# -------------------------------------------------------------------------------------------------------
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 5 robust -1')
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 5 robust -1', print_statements=False)
# -----------------------------------------------------------------

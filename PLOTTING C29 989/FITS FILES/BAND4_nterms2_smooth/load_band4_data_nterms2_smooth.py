...
loc = constants.band4_nterms2_smooth_data_folder_path
...
StokesI_file         = loc + "IRS63_BAND4_nterms2_StokesI_smooth_wrt_band5.fits"
StokesQ_file         = loc + "IRS63_BAND4_nterms2_StokesQ_smooth_wrt_band5.fits"
StokesU_file         = loc + "IRS63_BAND4_nterms2_StokesU_smooth_wrt_band5.fits"
POLI_biased_file     = loc + "POLI_biased_mJy_BAND4_nterms2_smooth.fits"
POLI_err_file        = loc + "POLI_err_mJy_BAND4_nterms2_smooth.fits"
POLI_dedebiased_file = loc + "POLI_debiased_mJy_BAND4_nterms2_smooth.fits"
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band4_nterms2_smooth)
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band4_nterms2_smooth)
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 4 nterms2 smooth')
...
results = generate_polarization_vectors(ny, nx,
                                        ...
                                        constants.minor_angle_rad_sky_band4_nterms2_smooth,
                                        StokesI_mJy,
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 4 nterms2 smooth', print_statements=False)
# -----------------------------------------------------------------

...
loc = constants.band7_nterms2_smooth_data_folder_path
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band7_nterms2)
print('Using BAND7 nterms 2 error for Stokes I, not updated for smoothed')
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band7_nterms2)

print('Using BAND7 nterms 2 error for Stokes Q, not updated for smoothed')
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band7_nterms2)

print('Using BAND7 nterms 2 error for Stokes U, not updated for smoothed')
# -------------------------------------------------------------------------------------------------------
...
# find_POLF_avg("Band 7 nterms2 smooth", POLF, StokesI_mJy, loc)
# -------------------------------------------------------------------------------------------------------
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 7 nterms2 smooth')
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 7 nterms2 smooth', print_statements=False)
# -----------------------------------------------------------------
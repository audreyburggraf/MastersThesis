...
band5_robust_minus2_data_folder_path = constants.band5_robust_minus2_data_folder_path
...
# Define file paths
StokesI_file = band5_robust_minus2_data_folder_path + "IRS63_BAND5_StokesI_redo_nterms1_robust_minus2.fits"
StokesQ_file = band5_robust_minus2_data_folder_path + "IRS63_BAND5_StokesQ_redo_nterms1_robust_minus2.fits"
StokesU_file = band5_robust_minus2_data_folder_path + "IRS63_BAND5_StokesU_redo_nterms1_robust_minus2.fits"
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band5_robust_minus2)
# -------------------------------------------------------------------------------------------------------
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band5_robust_minus2)
# -------------------------------------------------------------------------------------------------------
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band5_robust_minus2)
# -------------------------------------------------------------------------------------------------------
...
hdu.writeto(band5_robust_minus2_data_folder_path + "POLI_mJy_calculated_BAND5_robust_minus2.fits", overwrite=True)
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 5 robust -2')
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 5 robust -2', print_statements=False)
# -----------------------------------------------------------------

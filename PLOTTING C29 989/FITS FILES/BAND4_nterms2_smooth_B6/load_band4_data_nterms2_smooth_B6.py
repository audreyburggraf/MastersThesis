...
loc = constants.band4_nterms2_smooth_B6_data_folder_path
...
# Stokes I error
# -------------------------------------------------------------------------------------------------------
StokesI_err_mJy = np.full((ny, nx), constants.StokesI_err_mJy_band4_nterms2_smooth_B6)
...
# Stokes Q Error
# -------------------------------------------------------------------------------------------------------
StokesQ_err_mJy = np.full((ny, nx), constants.StokesQ_err_mJy_band4_nterms2_smooth_B6)
...
# Stokes U Error
# -------------------------------------------------------------------------------------------------------
StokesU_err_mJy = np.full((ny, nx), constants.StokesU_err_mJy_band4_nterms2_smooth_B6)
...
BMAJ_deg, BMIN_deg, BMAJ_pix, BMIN_pix, BPA_deg_cartesian, reference_length_pix, RA_centre_pix, Dec_centre_pix, xmin, xmax, ymin, ymax = get_plotting_parameters(StokesI_header, StokesI_wcs, 'Band 4 nterms2 smooth B6')
...
# Save the beam info
# -----------------------------------------------------------------
save_beam_info(StokesI_header, 'Band 4 nterms2 smooth B6', print_statements=False)
# -----------------------------------------------------------------

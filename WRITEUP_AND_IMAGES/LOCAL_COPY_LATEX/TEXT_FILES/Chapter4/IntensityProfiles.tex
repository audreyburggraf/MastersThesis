...
\begin{figure*}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Slices/MinorAxisSliceGrid_robust_minus1_Delta.pdf}
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Slices/MW_slices_GRID.pdf}

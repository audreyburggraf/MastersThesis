...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Ratio/Best_grid_Delta.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Gaussian/Best_grid_Delta.pdf}
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Gaussian/Best_grid_Delta_map.pdf}

...
\begin{figure}[h]
  \centering
  \includegraphics[width=1.1\textwidth]{../IMAGES/WRITEUP/Ratio/RatioExamplesTest_Band4_NoAxes.pdf}
...
The Gaussian was rotated to align with the major axis of the disk, using the position angle of the disk given in Table \ref{tab: source_info}). The coordinates ($x, y$) were shifted with respect to the centre of the disk ($x_c, y_c$) and then rotated:
\begin{equation}
\begin{pmatrix}
X_M \\
Y_m
...
Two examples of the Gaussian weight map, with polarization vectors overlaid, are shown in Figure \ref{fig: Methods/GaussianExamples} for selected values of $\phi$, BMIN, and BMAJ.


\begin{figure*}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../IMAGES/WRITEUP/Gaussian/CustomExamples_B4.pdf}

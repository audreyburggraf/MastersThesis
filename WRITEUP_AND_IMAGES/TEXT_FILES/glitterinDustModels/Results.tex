...
\begin{figure}[htbp]
  ...
  \caption{Same as Figure \ref{fig: Spherical_BEST} but for irregular dust grains. Porosity is fixed, and the grid shows the results for each fitting case. Corresponding results can be found in Table \ref{tab: dust_model_fits_irregular}. } 

...
\begin{figure*}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{WRITEUP_AND_IMAGES/IMAGES/WRITEUP/GalaxyContamination/StokesI_BothBands.pdf}
...
It was predicted that this background source may be a background galaxy. The method used to determine the likelihood of detecting a background galaxy was adapted from Section 5.5 in in \cite{sadavoy_dust_2019}. 

\add{Some sentence about why we can't do this at Band 5.}

Using \cite{GC_Number_Counts} for the Band 7 number counts, the Schecter function is used to find the number of galaxies per \question{area?}
\begin{equation}

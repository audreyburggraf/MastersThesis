...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{WRITEUP_AND_IMAGES/IMAGES/WRITEUP/glitterin/Pw_vs_grainsize}
  \end{minipage}

  \caption{Same as Figure \ref{fig:Pweff_vs_grainsize} but for \Pw instead of \PweffNS. }
  %\label{fig: Pw_vs_grainsize_appendix}
\end{figure}
% ----------------------------------------------

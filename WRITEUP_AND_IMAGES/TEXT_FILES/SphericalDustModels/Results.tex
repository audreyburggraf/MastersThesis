...
\begin{table}[h!]
\centering
\caption[Spherical dust grain model fitting results.]{Spherical dust grain model fitting results, including the scale factor $\chi_\mathcal{P}^2$, and best-fit grain size. The best fit for each fit case is shown in bold text. }
\begin{tabular}{lcccc}
\toprule

...
\begin{figure}[htbp]
  ...
  \caption{Absorption and effective scattering mass opacities as a function of observing wavelength for grain sizes of 1\micron and 100 \micron for compact (left) and porous (right) grains. Blue box corresponds to lower limit of \bseven and upper limit of \bfourNS. \coded{Only effective and x-axis to mm} \question{Still have to say "Recreation of Figure 1 from Kataoka et al. (2015)." if i changed it to effective scattering and added 2 porosities? }}

...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.99\textwidth]{WRITEUP_AND_IMAGES/IMAGES/WRITEUP/DustModels/Kataoka2015Fig1_grid.pdf}
  \caption{Absorption and scattering mass opacities as a function of observing wavelength for grain sizes of 1\micron and 100 \micron for compact (left) and porous (right) grains. Recreation of Figure 1 from \cite{Kataoka_2015}. \intextref{update after plot change}  \asked{I think I should be showing effective scattering since that's what we use to calculate \weffNS, this is shown in Figure \ref{fig: Kataoka2015Figure1Recreation_eff}}}
...
An additional quantity is the single scattering albedo, which describes the fraction of the original light that is removed by scattering rather than absorption. The standard and effective albedo are defined as \citep{Zhang2023} \asked{Do I even need to show the standard albedo equation?}:
\begin{equation}

...
% ----------------------------------------------
Multiple wavelength combinations were tested to determine the effect of each wavelength of data on the success of the fit. The fits were (1) all wavelengths, (2) no \bfiveNS, (3) no \bsixNS, and (4) just \bfour and \bsevenNS. A chi-squared value was calculated at each fitting combination and porosity to determine the agreement between the model and observations, given by: 
\begin{equation}

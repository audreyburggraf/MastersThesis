...
\section{Equations and Values}
\begin{table}[h!]
\centering
\caption{}
\label{tab: GC_Equation_table}
\begin{tabular}{cccccc}
\toprule
\textbf{Equation } & $\lambda$ & \textbf{$N_0$} & \textbf{$S_0$} & \textbf{$\alpha$} & \textbf{Source} \\
\midrule 
$\frac{dN}{dS}dS=\phi_*\left(\frac{S}{S_*}\right)^\alpha \exp(-\frac{S}{S_*})d\frac{S}{S_*}$ & \\
\bottomrule
\end{tabular}
\end{table}

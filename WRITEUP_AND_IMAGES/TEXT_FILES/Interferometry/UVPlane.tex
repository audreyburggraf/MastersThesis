...
\begin{figure*}[h]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \captionof{figure}{Schematic showing the \uv coverage.  Image taken from \cite{Monnier} \note{Have to ask for permission, just a screnshot, can get better quality} \SC{the (u,v) coverage of what?  Something is missing here.  Perhaps mention that the tracks show the sky rotation from individual antenna pairs.}}

...
\SC{Try to avoid referencing presentations.  Conference proceedings or published notes are fine, but Laura's presentation is not published.  If you can look back on the slides, she probably referenced published works like Tools for Radio Astronomy by Tom Wilson, et al.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

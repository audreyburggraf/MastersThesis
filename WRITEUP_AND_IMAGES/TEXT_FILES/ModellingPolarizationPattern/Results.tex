...
\begin{table}[h!]
\centering
\caption{Ratio model fitting results for each wavelength, with goodness-of-fit quantified by $\chi^2_{reduced}$. Best fits are shown in bold. }
\begin{tabular}{lcccc}
\toprule
...
\begin{figure}[htbp]
  ...
  \caption{Figure \ref{fig: StokesI_POLI_grid}, overplotted with the polarization vectors in red from the best-fit ratio model at each wavelength. The corresponding best-fit ratio models are listed in Table \ref{tab:ratio_model_chi2}. \code{AU to au}}
...
\begin{figure}[htbp]
  ...
  \caption{Same as Figure \ref{fig: RatioBestGrid}, but for the best-fit Gaussian models. The corresponding best-fit Gaussian models are listed Table \ref{tab:gaussian_top5}. \code{AU to au}}
...
\begin{figure}[htbp]
  ...
  \caption{Maps of the Gaussian uniform weights $W_{\text{uniform}}$ (Equation \ref{eq: gaussian_eq}) for the best-fit Gaussian model for each wavelength, corresponding vector pattern shown in Figure \ref{fig: GaussianBestGrid}. \code{change to b, a}}

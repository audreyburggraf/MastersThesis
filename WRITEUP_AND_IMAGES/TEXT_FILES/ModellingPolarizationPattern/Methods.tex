...
To achieve this, we used a rotated 2-dimensional flat-topped Gaussian model with three free parameters: $\phi$, $b$ and $a$, summarized in Table \ref{tab: gaussian_model_info}. The tested values of $b$ and $a$ control the widths of the Gaussian model, with each treated as the FWHM and converted to standard deviations using Equation \ref{eq: FWHM_to_sigma}. Additionally, a condition of $b$ $\leqq $ $a$ was required to ensure the minor axis was smaller than the major axis. 

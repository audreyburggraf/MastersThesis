...
\begin{figure}[htbp]
  ...
  \caption[Schematic of three polarization morphologies.]{Schematic of three polarization morphologies and a potential mechanism causing them. The image is from \cite{Kataoka_2017}. \permission{ask permission to use} }

...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \captionof{figure}{\SI image of IRS 63 at \bsixNS. Polarization vectors are shown as black lines and are scaled by polarization fraction.  Image from \cite{sadavoy_dust_2019}.  \permission{ask for permission} \question{Take off RA and Dec numbers?}}

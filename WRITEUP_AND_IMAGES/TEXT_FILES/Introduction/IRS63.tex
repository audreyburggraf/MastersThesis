...
\begin{figure*}[h]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \captionof{figure}{\SI image of IRS 63 at \bsixNS. Polarization vectors are shown as black lines and are scaled by polarization fraction.  Image from \cite{sadavoy_dust_2019}. \add{higher resolution image} \note{ask for permission}}

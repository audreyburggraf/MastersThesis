...
\begin{figure}[htbp]
  ...
  \caption[Comparison in structure for IRS 63 and HL Tau.]{Continuum emissions of HL Tau (left) and IRS 63 (right). Reproduced with permission from \cite{ALMAPartnership} (left) and \cite{Dom2020}(right) \cite{Dom2020}. }

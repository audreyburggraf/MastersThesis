...
\begin{figure}[htbp]
  ...
  \caption[Comparison in structure for IRS 63 and HL Tau.]{Continuum emission from HL Tau (left) and IRS 63 (right), both shown st a spatial resolution of 5 au. Scale bars represent 40 au. The HL Tau image is credited to ALMA (ESO/NAOJ/NRAO). The IRS 63 image is reproduced with permission from \cite{Dom2020}.} 

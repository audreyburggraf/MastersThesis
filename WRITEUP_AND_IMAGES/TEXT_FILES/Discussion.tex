...
\begin{figure}[htbp]
  ...
  \caption[Comparison in structure for IRS 63 and HL Tau.]{Continuum emission from HL Tau (left) and IRS 63 (right), both shown at a spatial resolution of 5 au. Scale bars represent 40 au. Left: image adapted from ALMA (ESO/NAOJ/NRAO). Right: image credit: MPE/D. Segura-Cox.} 
  \label{fig: HLTauIRS63}
\end{figure}  
  %\cite{ALMAPartnership} 
  % https://www.almaobservatory.org/en/announcements/iconic-alma-image-quoted-in-over-a-thousand-scientific-papers-in-less-than-a-decade/
% Image now from 

...
% -------------------------------------------------------------
IRS 63 was observed in full polarization by ALMA at \bfour (Band 4), \bfive (Band 5), \bsix (Band 6), and \bseven (Band 7) between 2017 and 2022. The \bandsixmm polarization observations were originally presented in \cite{sadavoy_dust_2019} (project ID: 2015.1.01112.S), and the remaining datasets were from project ID: 2018.1.00769. Table \ref{tab: alma_observations} outlines information about the observations.

% were presented in \cite{tobin} as continuum only (project ID: 2018.1.00769.S). Table \ref{tab: alma_observations} outlines information about the observations.
% -------------------------------------------------------------
...
\begin{tablenotes}
% \footnotesize
\item \textbf{Note:} \SIerrNS, \SQerrNS, and \SUerr are representative of the sensitivity at the phase centre for each wavelength. 
\end{tablenotes}
...
\begin{table}[h!]
\centering
\caption[Summary of Stokes and polarization parameters.]{Summary of Stokes and polarization parameters, their associated error symbols, and units. }
\begin{tabular}{llll}
\toprule
...
\begin{equation}
    ...
    \label{eq: POLF}
\end{equation}
\noindent where $I$ is \SI intensity. The uncertainty on the polarization fraction is:
...
\noindent When measuring the angles, the zero-degree position is defined as North, with the polarization angle increasing counterclockwise from North to East. The coordinate system was previously shown in Figure \ref{fig: LinearPol}. 

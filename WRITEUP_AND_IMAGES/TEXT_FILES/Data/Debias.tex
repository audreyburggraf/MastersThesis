...
The polarized intensity was debiased using the method explained in \cite{sadavoy_dust_2019}, originally from \cite{HullDebias}. Variables used in these equations and further into this section are summarized in Table \ref{tab: stokes_polar_variables}. The following equations in this Chapter are from \cite{CoudeEquations}, unless specified otherwise. 



\begin{table}[h!]
\centering
\caption{Summary of Stokes and polarization parameters, their associated error symbols, and units.}
\begin{tabular}{llll}
\toprule
...
This method calculates the debiased polarized intensity, \POLIns, with a corresponding error of \POLIerr, with the equation:

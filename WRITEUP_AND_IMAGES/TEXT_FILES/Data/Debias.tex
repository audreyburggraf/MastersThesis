...
The polarized intensity was debiased using the method explained in \cite{sadavoy_dust_2019}, originally from \cite{HullDebias}. Variables used in these equations and further into this section are summarized in Table \ref{tab: stokes_polar_variables}. This method calculates the debiased polarized intensity, \POLIns, with a corresponding error of \POLIerrNS, with the equation:
...
\begin{table}[h!]
\centering
\caption{Summary of Stokes and polarization parameters, their associated error symbols, and units. \SC{Units in the above table are in uJy/beam.  If you want to have them in mJy/beam, then you need to report them as such.  Or change the unit in the table.}  }
\begin{tabular}{llll}
\toprule

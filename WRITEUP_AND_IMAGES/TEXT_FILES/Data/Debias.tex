...
\begin{equation}
    ...
    \label{eq: POLI}
\end{equation}
\noindent which always yields a positive value as $Q$ and $U$ are both squared. \SCC{comment} To eliminate this bias towards an always positive, and as a result, larger polarized intensity value, we need to  calculate a debiased polarized intensity value. 

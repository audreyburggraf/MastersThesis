...
\begin{tablenotes}
\footnotesize
\item \textbf{Note:} \SIerrNS, \SQerrNS, \SUerr are constant values for \bfourNS, \bfiveNS, and \bsevenNS. For \bsixNS, the uncertainties were provided as maps; the values reported in this table correspond to the pixel with the maximum \SI value. \note{Stoes Q and U errors for Band 5 were previously listed at 41, not sure where I got those values from. Checked the files and they are updated property now. The Stokes I error did not change}
\end{tablenotes}

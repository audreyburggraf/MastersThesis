...
IRS 63 was observed in full polarization by ALMA at \bfour (Band 4), \bfive (Band 5), \bsix (Band 6), and \bseven (Band 7) between 2017 and 2022 \add{project ID}. The \bandfivemm polarization observations were originally presented in \cite{sadavoy_dust_2019}, and the remaining datasets were presented in \cite{tobin} as continuum only. Information about the observations is outlined in Table \ref{tab: alma_observations}.

...
\begin{table}[h!]
\centering
\caption{ALMA Observation Information. \note{Some info does not match the table in \citep{Tobin2024}: # antenna for B4, # antenna for B7, dates for B6 and time on source from B6 but thats from \citep{sadavoy_dust_2019} paper so maybe I read it wrong} }
\begin{tabular}{lllll}
\toprule

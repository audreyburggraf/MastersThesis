...
The Nyquist-Shannon sampling theorem was used to determine the pixel spacing between vectors to make sure we are not under- or over-sampling relative to the size of the beam at each band. 
...
Beyond the step size, we also have to ensure that the vector is reliable. The vector is plotted if it meets the conditions:
\begin{equation}

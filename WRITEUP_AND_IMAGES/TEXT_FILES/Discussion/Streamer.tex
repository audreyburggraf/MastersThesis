...
\begin{figure}[htbp]
  ...
  \caption{Moment 0 map of p-H$_2$CO $3(0,3)-2(0,2)$ from IRS 63, showing the disk and the streamer in the southeast region. The grey dashed box is the region shown in Figure \ref{fig: Band5_robust05}. Image from \cite{Podio}. \permission{ask for permission.} \code{add grey box}}
  \label{fig: streamer}
\end{figure}
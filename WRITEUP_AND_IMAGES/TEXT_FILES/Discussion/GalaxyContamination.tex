...
\begin{figure*}[h]
  \centering
  \includegraphics[width=0.99\textwidth]{WRITEUP_AND_IMAGES/IMAGES/WRITEUP/GalaxyContamination/StokesI_BothBands.pdf}
  \caption{\SI images at (left) \bfive (\texttt{robust = 0.5}) and (right) \bsevenNS, showing the detected background source. }
...
\noindent Both the probability within each annulus and the cumulative probability as a function of radius are shown in Figure \ref{GalaxyContamination_Prob_B7}. 
